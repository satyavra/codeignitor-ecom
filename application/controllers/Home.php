...
class Home extends MY_Controller
{
    ...
    {
       $this->load->view($this->template . 'Home-parts/sliding-cat');
        $this->load->view($this->template . 'Home-parts/best-selling-items');
        $this->load->view($this->template . 'Home-parts/bank-and-promp');
        $this->load->view($this->template . 'Home-parts/smart-bachat');
        $this->load->view($this->template . 'Home-parts/buy-one-get-one');
        $this->load->view($this->template . 'Home-parts/top-saver-today');
        $this->load->view($this->template . 'Home-parts/card-categary');
    ...
    function submenuLoad(){
      $this->load->view($this->template . '_parts/header');  
    $this->load->view($this->template . 'submenu/submenu');
